...
public class Zoho extends TestBase{
	...
	public void testApp() throws InterruptedException {
		...
		//wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@id='tos']")));
		//wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//input[@id='tos']")));
